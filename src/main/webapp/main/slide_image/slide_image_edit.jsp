...
<body>
<form id="slide_image_edit_form" method="post">
    <table>
        <tr>
            <td>文件编号</td>
            <td>
                <input name="id" title="文件编号" readonly
...
<script>
    $(function () {
        $("#slide_image_edit_form").form({
            url: "<c:url value="/sli/modify"/>"
        }).form("load", "<c:url value="/sli/queryOne?id="/>" + slideImageId);
    });
</script>
</body>
</html>
